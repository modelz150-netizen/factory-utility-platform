...
| ARC-004 | P0 | Review | Architecture | Define Platform Architecture v1.0 | The platform context, module and dependency boundaries, host and integration adapters, data and security boundaries, deployment concept, quality architecture, MVP boundary, risks, validation criteria, and eight required views are documented without production Dashboard code or live AI/SCADA implementation. |
