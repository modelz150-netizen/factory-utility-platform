...
| GOV-016 | P0 | Review | Governance | Mark the legacy Project Charter as Superseded | The dedicated transition PR marks `PROJECT_CHARTER.md` Superseded, links the root Master Project Charter, preserves all historical content and legacy paths, aligns authority references, passes independent QA, and awaits CTO review without changing constitutional content or frozen architecture. |
