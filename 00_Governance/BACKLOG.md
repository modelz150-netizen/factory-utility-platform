...
| GOV-010 | P1 | Review | Governance | Normalize Project and Platform terminology | Draft Chapter 10 defines Project, Product, Platform, Repository, and Organization and awaits CTO approval. |
| GOV-011 | P1 | Review | Governance | Standardize Governance modal terminology | Draft Chapter 10 defines shall, must, should, may, prohibitions, capability language, and future-state language and awaits CTO approval. |
...
| GOV-025 | P0 | Review | Governance | Create Master Project Charter Chapter 10 | Draft PR #14 implements Documentation Governance only, resolves GOV-010 and GOV-011, preserves Chapters 1 through 9, passes independent QA, and introduces no Chapter 11 content. |
