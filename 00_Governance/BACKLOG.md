...
| GOV-005 | P0 | Review | Governance | Separate Founder and Chief AI authority | Chapter 7 distinguishes constitutional stewardship from delegated AI authority without adding routine operational burden to the Founder. |
| GOV-006 | P0 | Review | Governance | Define Chief AI accountability and operational boundaries | Chapter 7 defines responsibilities, prohibited authority, escalation, evidence, lifecycle accountability, and human authority boundaries. |
...
| GOV-019 | P0 | Review | Governance | Create Master Project Charter Chapter 7 | Draft PR #8 adds only Chapter 7, AI Organization and Chief AI Responsibilities, preserves approved Chapters 1 through 6, passes independent validation, and introduces no later chapter. |
