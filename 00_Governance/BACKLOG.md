...
| GOV-015 | P0 | Review | Governance | Create Master Project Charter Chapter 5 | A separate PR adds only Chapter 5, Quality Principles, preserves approved Chapters 1 through 4, and introduces no later chapter. |
...
| GOV-017 | P0 | Review | Governance | Complete the Chapters 1-5 Milestone Review | Review constitutional consistency, duplication, responsibility boundaries, hierarchy, terminology, and simplification before Chapter 6 is authorized. |
