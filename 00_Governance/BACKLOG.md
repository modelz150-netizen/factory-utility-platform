...
| ARC-001 | P0 | Review | Architecture | Define WordPress project and module architecture | The Phase 2-A foundation defines one plugin composition root, PSR-4 namespaces, physical module boundaries, compile-safe contracts, Composer tooling, static analysis, PHPUnit, and dependency fitness gates without Product behavior or excluded integrations. |
